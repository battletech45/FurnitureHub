...
const Navbar = () => {
  return (
    <nav className="flex items-center bg-white text-white relative px-12 p-8">
  ...
  <div className="w-full justify-center flex gap-14">
    ...
    <a className="text-[black] text-base not-italic font-medium leading-[normal] no-underline" href="/about">
      About
    </a>
