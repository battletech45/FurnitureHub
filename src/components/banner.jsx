...
const HeroBanner = ({ title }) => {
  return (
    <div className="w-full h-[400px] bg-[url('../../public/assets/bannerImage.png')] bg-cover bg-center bg-white text-center flex items-center">
      <div className="w-full flex flex-col items-center">
        ...
        <div className="flex justify-center items-center">
          <p className="text-black text-2xl font-medium mr-4"> Home </p>
